...
description: This tutorial guides you through deploying bookistudios AI to a production environment using Docker Compose for multi-user access.
---

import { Callout, Steps } from "nextra/components";

# Deploy Your Own bookistudios AI

This tutorial guides you through deploying bookistudios AI to a production environment using Docker Compose for multi-user access.
...
- Back up `backend/.bookistudios-ai/` directory regularly
