...
description: This tutorial shows you how to enable and use bookistudios AI's memory system so the agent remembers important information about you across multiple sessions.
---
...
This tutorial shows you how to enable and use bookistudios AI's memory system so the agent remembers important information about you across multiple sessions.
...
Memory is stored in `backend/.bookistudios-ai/memory.json`:

```bash
cat backend/.bookistudios-ai/memory.json
```
...
```
backend/.bookistudios-ai/agents/{agent_name}/memory.json
```
...
- [Deploy Your Own bookistudios AI](/docs/tutorials/deploy-your-own-bookistudio)
