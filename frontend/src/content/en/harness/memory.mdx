---
title: Memory
description: Memory is a runtime feature of the bookistudios AI Harness. It is not a simple conversation log — it is a structured store of facts and context summaries that persist across separate sessions and inform the agent's behavior in future conversations.
---
...
<Callout type="info" emoji="💾">
  Memory lets bookistudios AI carry useful information across sessions. The agent
...
Memory is a runtime feature of the bookistudios AI Harness. It is not a simple conversation log — it is a structured store of facts and context summaries that persist across separate sessions and inform the agent's behavior in future conversations.
...
memory:
  ...
  # Default: {base_dir}/memory.json  (resolves to backend/.bookistudios-ai/memory.json)
  ...
  storage_class: bookistudio.agents.memory.storage.FileMemoryStorage
...
bookistudios AI supports two levels of memory:
...
- Base directory: `backend/.bookistudios-ai/`
- Global memory: `backend/.bookistudios-ai/memory.json`
- Per-agent memory: `backend/.bookistudios-ai/agents/{agent_name}/memory.json`
