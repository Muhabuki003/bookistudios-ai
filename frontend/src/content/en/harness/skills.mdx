...
bookistudios AI ships with the following public skills:
...
- **Through the bookistudios AI App UI**: the skills panel lets you toggle skills on and off.
...
bookistudios AI includes an optional **skill evolution** feature that allows the agent to autonomously create and improve skills in the `skills/custom/` directory:
