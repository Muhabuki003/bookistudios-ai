...
<Callout type="info" emoji="📦">
  ...
  command-based work. It is what makes bookistudios AI capable of real action, not just
  conversation.
</Callout>
...
bookistudios AI supports three sandbox modes. Choose the one that fits your deployment:
...
sandbox:
  ...
  # Optional: container name prefix (default: bookistudios-ai-sandbox)
...
| `.bookistudios-ai/threads/{thread_id}/user-data/` | `/mnt/user-data/`                            | Read-write |
