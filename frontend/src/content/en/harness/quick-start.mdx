---
title: Quick Start
description: Learn how to create and run a bookistudios AI agent with create_deerflow_agent, from model setup to streaming responses.
---
...
bookistudios AI Harness requires Python 3.12 or later. The package is part of the `deerflow` repository under `backend/packages/harness`.
