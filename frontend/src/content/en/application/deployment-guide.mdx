...
description: "This guide covers all supported deployment methods for bookistudios AI App: local development, Docker Compose, and production with Kubernetes-managed sandboxes."
---
...
This guide covers all supported deployment methods for bookistudios AI App: local development, Docker Compose, and production with Kubernetes-managed sandboxes.

## Local development deployment

The local workflow is the fastest way to run bookistudios AI. All services run as native processes on your machine.
...
| ----------- | ---- | ------------------------ |
| LangGraph   | 2024 | bookistudios AI Harness runtime |
...
```bash
# Set the absolute path to your bookistudios-ai repo root
export DEER_FLOW_ROOT=/path/to/bookistudios-ai
...
# .env
OPENAI_API_KEY=sk-...
DEER_FLOW_ROOT=/absolute/path/to/bookistudios-ai
...
Thread data is stored in `backend/.bookistudios-ai/threads/`. In Docker deployments, this directory is bind-mounted into the langgraph container.
...
USERDATA_PVC_NAME=bookistudios-ai-userdata-pvc
SKILLS_PVC_NAME=bookistudios-ai-skills-pvc
```
...
bookistudios AI App uses [Better Auth](https://www.better-auth.com/) for session management. In production:
