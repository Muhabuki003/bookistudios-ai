---
title: bookistudios AI App
description: bookistudios AI App is the reference implementation of what a production bookistudios AI experience looks like. It assembles the Harness runtime, a web-based conversation workspace, an API gateway, and a reverse proxy into a single deployable system.
---
...
<Callout type="info" emoji="🚀">
  bookistudios AI App is a complete Super Agent application built on top of bookistudios AI
...
bookistudios AI App is the reference implementation of what a production bookistudios AI experience looks like. It assembles the Harness runtime, a web-based conversation workspace, an API gateway, and a reverse proxy into a single deployable system.
...
The bookistudios AI App runs as four services behind a single nginx reverse proxy:
...
- **LangGraph**: the bookistudios AI Harness runtime. Manages thread state, agent execution, and streaming.
...
| Agent runtime     | LangGraph, LangChain, bookistudios AI Harness                               |
| Reverse proxy     | nginx                                                                |
