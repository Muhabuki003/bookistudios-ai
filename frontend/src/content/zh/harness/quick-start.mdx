---
title: 快速上手
description: 学习如何使用 create_deerflow_agent 创建并运行 bookistudios AI Agent，从模型初始化到流式响应。
---
...
bookistudios AI Harness 需要 Python 3.12 或更高版本。该包是 `deerflow` 代码库的一部分，位于 `backend/packages/harness` 下。
