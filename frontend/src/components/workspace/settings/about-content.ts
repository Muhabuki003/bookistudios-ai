/**
 * About bookistudios AI markdown content. Inlined to avoid raw-loader dependency
 * (Turbopack cannot resolve raw-loader for .md imports).
 */
export const aboutMarkdown = `# 🦌 [About bookistudios AI 2.0](https://github.com/bytedance/bookistudios-ai)
...
* **Skills & Tools**: With built-in and extensible skills and tools, bookistudios AI can do almost anything.
...
![Star History Chart](https://api.star-history.com/svg?repos=bytedance/bookistudios-ai&type=Date)

Explore bookistudios AI on GitHub: [github.com/bytedance/bookistudios-ai](https://github.com/bytedance/bookistudios-ai)

## 🌐 Official Website

Visit the official website of bookistudios AI: [deerflow.tech](https://deerflow.tech/)
