...
export const enUS: Translations = {
  ...
  // Workspace
  workspace: {
    officialWebsite: "bookistudios AI's official website",
    githubTooltip: "bookistudios AI on Github",
    settingsAndMore: "Settings and more",
    visitGithub: "bookistudios AI on GitHub",
    reportIssue: "Report a issue",
    contactUs: "Contact us",
    about: "About bookistudios AI",
    logout: "Log out",
  },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "Install skill and make it available to bookistudios AI",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription:
      "Navigate bookistudios AI faster with keyboard shortcuts.",
  ...
  settings: {
    title: "Settings",
    description: "Adjust how bookistudios AI looks and behaves for you.",
    sections: {
      account: "Account",
    ...
    memory: {
      title: "Memory",
      description:
        "bookistudios AI automatically learns from your conversations in the background. These memories help bookistudios AI understand you better and deliver a more personalized experience.",
    ...
    skills: {
      ...
      emptyDescription:
        "Put your agent skill folders under the `/skills/custom` folder under the root folder of bookistudios AI.",
      emptyButton: "Create Your First Skill",
    },
    notification: {
      title: "Notification",
      description:
        "bookistudios AI only sends a completion notification when the window is not active. This is especially useful for long-running tasks so you can switch to other work and get notified when done.",
      requestPermission: "Request notification permission",
      deniedHint:
        "Notification permission was denied. You can enable it in your browser's site settings to receive completion alerts.",
      testButton: "Send test notification",
      testTitle: "bookistudios AI",
