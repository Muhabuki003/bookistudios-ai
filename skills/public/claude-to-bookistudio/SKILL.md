---
name: claude-to-bookistudio
description: "Interact with bookistudios AI AI agent platform via its HTTP API. Use this skill when the user wants to send messages or questions to bookistudios AI for research/analysis, start a bookistudios AI conversation thread, check bookistudios AI status or health, list available models/skills/agents in bookistudios AI, manage bookistudios AI memory, upload files to bookistudios AI threads, or delegate complex research tasks to bookistudios AI. Also use when the user mentions bookistudio, deer flow, or wants to run a deep research task that bookistudios AI can handle."
---

# bookistudios AI Skill

Communicate with a running bookistudios AI instance via its HTTP API. bookistudios AI is an AI agent platform
built on LangGraph that orchestrates sub-agents for research, code execution, web browsing, and more.

## Architecture

bookistudios AI exposes two API surfaces behind an Nginx reverse proxy:
...
Verify bookistudios AI is running:
...
```bash
bash /path/to/skills/claude-to-bookistudio/scripts/chat.sh "Your question here"
```
...
- If health check fails, bookistudios AI is not running. Inform the user they need to start it.
