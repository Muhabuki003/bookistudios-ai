# Contributing to bookistudios AI

Thank you for your interest in contributing to bookistudios AI! This guide will help you set up your development environment and understand our development workflow.
...
|---------|-----------|------------|-------|
| `make dev` on one machine | 4 vCPU, 8 GB RAM | 8 vCPU, 16 GB RAM | Best when bookistudios AI uses hosted model APIs. |
...
`2 vCPU / 4 GB` environments often fail to start reliably or become unresponsive under normal bookistudios AI workloads.
...
```text
unable to get image 'bookistudios-ai-dev-langgraph': permission denied while trying to connect to the Docker daemon socket at unix:///var/run/docker.sock
```
...
4. Verify Docker access:
   ...
   docker ps
   ```
5. Retry the bookistudios AI command:
   ```bash
   make docker-stop
   make docker-start
   ```
...
Host Machine
  ↓
Docker Compose (bookistudios-ai-dev)
...
- Check existing [Issues](https://github.com/bytedance/bookistudios-ai/issues)
- Read the [Documentation](backend/docs/)
- Ask questions in [Discussions](https://github.com/bytedance/bookistudios-ai/discussions)

## License

By contributing to bookistudios AI, you agree that your contributions will be licensed under the [MIT License](./LICENSE).
