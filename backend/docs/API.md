...
This document provides a complete reference for the bookistudios AI backend APIs.

## Overview

bookistudios AI backend exposes two sets of APIs:
...
bookistudios AI's own Gateway and IM-channel paths mitigate this by defaulting to
  ...
  "files": [
    {
      ...
      "size": 1234567,
      "path": ".bookistudios-ai/threads/abc123/user-data/uploads/document.pdf",
      "virtual_path": "/mnt/user-data/uploads/document.pdf",
      "artifact_url": "/api/threads/abc123/artifacts/mnt/user-data/uploads/document.pdf",
      "markdown_file": "document.md",
      "markdown_path": ".bookistudios-ai/threads/abc123/user-data/uploads/document.md",
...
Remove bookistudios AI-managed local thread files under `.bookistudios-ai/threads/{thread_id}` after the LangGraph thread itself has been deleted.
...
Currently, bookistudios AI does not implement authentication. All APIs are accessible without credentials.

Note: This is about bookistudios AI API authentication. MCP outbound connections can still use OAuth for configured HTTP/SSE MCP servers.
...
> The `/api/langgraph/*` endpoints bypass bookistudios AI's Gateway and inherit
