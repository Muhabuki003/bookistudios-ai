...
This directory contains detailed documentation for the bookistudios AI backend.
...
| Document | Description |
|----------|-------------|
| [STREAMING.md](STREAMING.md) | Token-level streaming design: Gateway vs bookistudios AIClient paths, `stream_mode` semantics, per-id dedup |
...
1. **New to bookistudios AI?** Start with [SETUP.md](SETUP.md) for quick installation
