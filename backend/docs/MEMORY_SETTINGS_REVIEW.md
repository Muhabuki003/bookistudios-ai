...
1. Start bookistudios AI locally using any working development setup you already use.
   ...
   If you already have bookistudios AI running locally, you can reuse that existing setup.
...
- Default local runtime target: `backend/.bookistudios-ai/memory.json`
