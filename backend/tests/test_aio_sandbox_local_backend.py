...
def test_format_container_mount_uses_mount_syntax_for_docker_windows_paths():
    args = _format_container_mount("docker", "D:/bookistudios-ai/backend/.bookistudios-ai/threads", "/mnt/threads", False)

    assert args == [
        "--mount",
        "type=bind,src=D:/bookistudios-ai/backend/.bookistudios-ai/threads,dst=/mnt/threads",
    ]
