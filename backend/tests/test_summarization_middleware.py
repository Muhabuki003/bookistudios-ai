...
from deerflow.agents.middlewares.summarization_middleware import bookistudios AISummarizationMiddleware, SummarizationEvent
...
) -> bookistudios AISummarizationMiddleware:
    model = MagicMock()
