...
_THREAD_DATA = {
    "workspace_path": "/tmp/bookistudios-ai/threads/t1/user-data/workspace",
    "uploads_path": "/tmp/bookistudios-ai/threads/t1/user-data/uploads",
    "outputs_path": "/tmp/bookistudios-ai/threads/t1/user-data/outputs",
}
...
def test_replace_virtual_path_maps_virtual_root_and_subpaths() -> None:
    assert Path(replace_virtual_path("/mnt/user-data/workspace/a.txt", _THREAD_DATA)).as_posix() == "/tmp/bookistudios-ai/threads/t1/user-data/workspace/a.txt"
    assert Path(replace_virtual_path("/mnt/user-data", _THREAD_DATA)).as_posix() == "/tmp/bookistudios-ai/threads/t1/user-data"
...
def test_replace_virtual_path_preserves_trailing_slash() -> None:
    ...
    assert result == "/tmp/bookistudios-ai/threads/t1/user-data/workspace/"
...
def test_replace_virtual_path_preserves_trailing_slash_windows_style() -> None:
    ...
    """
    win_thread_data = {
        "workspace_path": r"C:\bookistudios-ai\threads\t1\user-data\workspace",
        "uploads_path": r"C:\bookistudios-ai\threads\t1\user-data\uploads",
        "outputs_path": r"C:\bookistudios-ai\threads\t1\user-data\outputs",
    }
...
def test_replace_virtual_path_preserves_windows_style_for_nested_subdir_trailing_slash() -> None:
    ...
    assert result == "C:\\bookistudios-ai\\threads\\t1\\user-data\\workspace\\subdir\\"
    assert "/" not in result, f"Mixed separators in Windows path: {result!r}"
...
def test_replace_virtual_paths_in_command_preserves_trailing_slash() -> None:
    ...
    assert "/tmp/bookistudios-ai/threads/t1/user-data/workspace/" in result, f"Trailing slash lost in: {result!r}"
...
def test_mask_local_paths_in_output_hides_host_paths() -> None:
    output = "Created: /tmp/bookistudios-ai/threads/t1/user-data/workspace/result.txt"
    masked = mask_local_paths_in_output(output, _THREAD_DATA)

    assert "/tmp/bookistudios-ai/threads/t1/user-data" not in masked
...
def test_mask_local_paths_in_output_hides_skills_host_paths() -> None:
    ...
    with (
        ...
        patch("deerflow.sandbox.tools._get_skills_host_path", return_value="/home/user/bookistudios-ai/skills"),
    ):
        output = "Reading: /home/user/bookistudios-ai/skills/public/bootstrap/SKILL.md"
        masked = mask_local_paths_in_output(output, _THREAD_DATA)

        assert "/home/user/bookistudios-ai/skills" not in masked
...
def test_resolve_skills_path_resolves_correctly() -> None:
    ...
    with (
        ...
        assert resolved == "/home/user/bookistudios-ai/skills/public/bootstrap/SKILL.md"
...
def test_resolve_skills_path_resolves_root() -> None:
    ...
    with (
        ...
        assert resolved == "/home/user/bookistudios-ai/skills"
...
def test_replace_virtual_paths_in_command_replaces_skills_paths() -> None:
    ...
    with (
        ...
        assert "/home/user/bookistudios-ai/skills/public/bootstrap/SKILL.md" in result
...
def test_replace_virtual_paths_in_command_replaces_both() -> None:
    ...
    with (
        ...
        assert "/tmp/bookistudios-ai/threads/t1/user-data/workspace/out.txt" in result
...
def test_replace_virtual_paths_in_command_replaces_acp_workspace() -> None:
    ...
    acp_host = "/home/user/.bookistudios-ai/acp-workspace"
    with patch("deerflow.sandbox.tools._get_acp_workspace_host_path", return_value=acp_host):
        ...
        assert "/tmp/bookistudios-ai/threads/t1/user-data/outputs/hello.py" in result
...
def test_apply_cwd_prefix_prepends_workspace() -> None:
    ...
    assert "/tmp/bookistudios-ai/threads/t1/user-data/workspace" in result
...
def test_file_operation_lock_memory_cleanup() -> None:
    ...
    test_path = "/tmp/bookistudios-ai/memory_leak_test_file.txt"
