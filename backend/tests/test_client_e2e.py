"""End-to-end tests for bookistudios AIClient.
...
from deerflow.client import bookistudios AIClient, StreamEvent
...
@pytest.fixture()
def client(e2e_env):
    """A bookistudios AIClient wired to the isolated e2e_env."""
    return bookistudios AIClient(checkpointer=None, thinking_enabled=False)
...
class TestFileUploadIntegration:
    ...
    def test_upload_files(self, e2e_env, tmp_path):
        ...
        c = bookistudios AIClient(checkpointer=None, thinking_enabled=False)
        tid = str(uuid.uuid4())
...
class TestLifecycleAndConfig:
    ...
    def test_plan_mode_config_key(self, e2e_env):
        ...
        c = bookistudios AIClient(checkpointer=None, plan_mode=False)
        ...
        c2 = bookistudios AIClient(checkpointer=None, plan_mode=True)
