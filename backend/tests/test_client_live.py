"""Live integration tests for bookistudios AIClient with real API.
...
def client():
    """Create a real bookistudios AIClient (no mocks)."""
    return bookistudios AIClient(thinking_enabled=False)
