...
def _create_summarization_middleware(*, app_config: AppConfig | None = None) -> bookistudiosAISummarizationMiddleware | None:
    ...
    return bookistudiosAISummarizationMiddleware(
        **kwargs,
