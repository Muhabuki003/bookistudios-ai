...
from deerflow.agents.middlewares.summarization_middleware import BeforeSummarizationHook, bookistudios AISummarizationMiddleware
...
def _create_summarization_middleware(*, app_config: AppConfig | None = None) -> bookistudios AISummarizationMiddleware | None:
    ...
    # the sole entry point for bookistudios AISummarizationMiddleware, and the runtime
    # config is not expected to change after startup.
    skills_container_path = resolved_app_config.skills.container_path or "/mnt/skills"

    return bookistudios AISummarizationMiddleware(
        **kwargs,
...
def _create_todo_list_middleware(is_plan_mode: bool) -> TodoMiddleware | None:
    ...
    # Custom prompts matching bookistudios AI's style
    system_prompt = """
<todo_list_system>
