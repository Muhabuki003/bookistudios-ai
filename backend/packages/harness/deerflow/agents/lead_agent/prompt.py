...
bookistudios AI is an open-source AI agent framework that gained significant traction in early 2026
[citation:GitHub Repository](https://github.com/bytedance/bookistudios-ai). The project focuses on
providing a production-ready agent system with sandbox execution and memory management
[citation:bookistudios AI Documentation](https://bookistudios-ai.dev/docs).
...
### Primary Sources
- [GitHub Repository](https://github.com/bytedance/bookistudios-ai) - Official source code and documentation
- [bookistudios AI Documentation](https://bookistudios-ai.dev/docs) - Technical specifications
...
- ✅ RIGHT in Sources: `[GitHub Repository](https://github.com/bytedance/bookistudios-ai) - 官方源代码和文档`
...
- Language: Respond in English ONLY. Never use Chinese or any other language unless the user explicitly asks in that language.
...
def apply_prompt_template(
    ...
    *,
    ...
    return SYSTEM_PROMPT_TEMPLATE.format(
        agent_name=agent_name or "bookistudios AI 2.0",
