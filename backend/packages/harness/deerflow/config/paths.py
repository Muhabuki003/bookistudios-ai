...
def _default_local_base_dir() -> Path:
    """Return the caller project's writable bookistudios AI state directory."""
    return runtime_home()
...
def _join_host_path(base: str, *parts: str) -> str:
    ...
    path form (for example ``C:\\repo\\backend\\.bookistudios-ai``).  Using
...
class Paths:
    """
    Centralized path configuration for bookistudios AI application data.
    ...
    BaseDir resolution (in priority order):
        ...
        3. Caller project fallback: `{project_root}/.bookistudios-ai`
    """
