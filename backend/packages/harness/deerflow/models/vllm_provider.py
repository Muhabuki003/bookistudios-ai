...
def _normalize_vllm_chat_template_kwargs(payload: dict[str, Any]) -> None:
    """Map bookistudios AI's legacy ``thinking`` toggle to vLLM/Qwen's ``enable_thinking``.

    bookistudios AI originally documented ``extra_body.chat_template_kwargs.thinking``
