...
class AgentResponse(BaseModel):
    ...
    show_in_office: bool = Field(default=False, description="Show agent as pixel character in BUKIMIND Office")
...
class AgentUpdateRequest(BaseModel):
    ...
    show_in_office: bool | None = Field(default=None, description="Show agent as pixel character in BUKIMIND Office")
...
def _agent_config_to_response(agent_cfg: AgentConfig, include_soul: bool = False, *, user_id: str | None = None) -> AgentResponse:
    ...
    return AgentResponse(
        ...
        soul=soul,
        show_in_office=agent_cfg.show_in_office,
    )
...
async def create_agent_endpoint(request: AgentCreateRequest) -> AgentResponse:
    ...
    try:
        ...
        if request.show_in_office:
            config_data["show_in_office"] = True
...
async def update_agent(name: str, request: AgentUpdateRequest) -> AgentResponse:
    ...
    try:
        ...
        config_changed = bool(fields_set & {"description", "model", "tool_groups", "skills", "show_in_office"})
        ...
        if config_changed:
            ...
            if agent_cfg.show_in_office:
                updated["show_in_office"] = True
            ...
            # Handle show_in_office toggle
            if "show_in_office" in fields_set:
                if request.show_in_office:
                    updated["show_in_office"] = True
                else:
                    updated["show_in_office"] = False
