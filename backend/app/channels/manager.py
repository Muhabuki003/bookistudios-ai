"""ChannelManager — consumes inbound messages and dispatches them to the bookistudios AI agent via Gateway."""
...
class ChannelManager:
    """Core dispatcher that bridges IM channels to the bookistudios AI agent.
    ...
    async def _handle_chat(self, msg: InboundMessage, extra_context: dict[str, Any] | None = None) -> None:
        ...
        # Look up existing bookistudios AI thread.
