...
COMPOSE_CMD="docker compose -p bookistudios-ai-dev -f docker-compose-dev.yaml"
...
init() {
    echo "=========================================="
    echo "  bookistudios AI Init — Pull Sandbox Image"
    echo "=========================================="
    echo ""
...
start() {
    ...
    echo "=========================================="
    echo "  Starting bookistudios AI Docker Development"
    echo "=========================================="
    echo ""
    ...
    if [ ! -f "$PROJECT_ROOT/config.yaml" ]; then
        if [ -f "$PROJECT_ROOT/config.example.yaml" ]; then
            ...
            echo -e "${YELLOW}  configuration before starting bookistudios AI.                  ${NC}"
            echo -e "${YELLOW}============================================================${NC}"
            echo ""
    ...
    echo ""
    echo "=========================================="
    echo "  bookistudios AI Docker is starting!"
    echo "=========================================="
    echo ""
...
stop() {
    ...
    "$SCRIPT_DIR/cleanup-containers.sh" bookistudios-ai-sandbox 2>/dev/null || true
...
restart() {
    echo "========================================"
    echo "  Restarting bookistudios AI Docker Services"
    echo "========================================"
    echo ""
...
# Show help
help() {
    echo "bookistudios AI Docker Management Script"
    echo ""
