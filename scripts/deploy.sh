#!/usr/bin/env bash
#
# deploy.sh - Build, start, or stop bookistudios AI production services
#
# Commands:
...
COMPOSE_CMD=(docker compose -p bookistudios-ai -f "$DOCKER_DIR/docker-compose.yaml")
...
if [ -z "$DEER_FLOW_HOME" ]; then
    export DEER_FLOW_HOME="$REPO_ROOT/backend/.bookistudios-ai"
fi
...
if [ "$CMD" = "down" ]; then
    ...
    export DEER_FLOW_HOME="${DEER_FLOW_HOME:-$REPO_ROOT/backend/.bookistudios-ai}"
...
if [ "$CMD" = "build" ]; then
    echo "=========================================="
    echo "  bookistudios AI — Building Images"
    echo "=========================================="
    echo ""
...
echo "=========================================="
echo "  bookistudios AI Production Deployment"
echo "=========================================="
echo ""
...
echo ""
echo "=========================================="
echo "  bookistudios AI is running!"
echo "=========================================="
echo ""
